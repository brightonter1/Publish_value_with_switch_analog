...
const char* ssid = "BrightV.1"; // ชื่อ เน็ต
const char* password = "123456789"; // รหัส เน็ต
...
/* ส่งค่าขึ้นระบบ สำหรับใช้ สวิชหมุน สามารถใช้คู่กับฟังชั่น AnalogWrite */ 
  ...
  itoa(Analog, AnalogStr, 10);
  Serial.println(Analog);
  client.publish(destinationTopic, AnalogStr);
  delay(0);
